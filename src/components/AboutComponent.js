...
function About(props) {
    ...
    const RenderPartner = ({ partners }) => {
        if(partners) {
            return(
                <React.Fragment>
                    <Media object src={`/assets/${partners.image}`} alt={partners.name} width='150'/>
        ...
        const partners = props.partners.partners.map(partner => {
            return (
                <Media tag="li" key={partner.id}>
                    <RenderPartner partners={partner} />
                </Media>
            )
        });
    ...
    return (
        <div className="container">
            ...
            <div className="row row-content">
                ...
                <div className="col-sm-6">
                    <Card>
                        <CardHeader className="bg-primary text-white"><h3>Facts At a Glƒ.mpance</h3></CardHeader>
                        <CardBody>
                            <dl className="row">
